...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-haluna-primary text-white hover:bg-haluna-primary-dark shadow-md hover:shadow-lg dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90 dark:hover:shadow-glow-md",
        ...
        link: "text-haluna-primary underline-offset-4 hover:underline dark:text-primary",
      },
      size: {
