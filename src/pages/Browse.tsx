...
const Browse = () => {
  ...
  return (
    <div className="container mx-auto px-4 pt-20 pb-10">
      <div className="mb-8">
        <h1 className="text-3xl font-serif font-bold text-[#2A866A] dark:text-[#4ECBA5] mb-2">Browse Shops</h1>
        <p className="text-gray-600 dark:text-gray-400">Discover local shops and their products</p>
      </div>
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge 
            ...
            className="cursor-pointer hover:bg-[#2A866A] hover:text-white dark:hover:bg-[#4ECBA5]"
              ...
              <Card className="overflow-hidden h-full hover:shadow-md transition-shadow">
                <div className="relative h-48 bg-gray-100 dark:bg-gray-800">
                  {shop.cover_image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-[#E4F5F0] dark:bg-[#2A866A]/20">
                      <Store className="h-12 w-12 text-[#2A866A] dark:text-[#4ECBA5]" />
                    </div>
                  )}
                  
                  <div className="absolute top-3 left-3">
                    <Badge variant="secondary" className="bg-white/90 dark:bg-black/50 text-gray-800 dark:text-gray-200">
                      {shop.category}
                    </Badge>
                  </div>
                      ...
                      <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                        {shop.rating ? (
                          <div className="flex items-center text-amber-500 mr-2">
                            ...
                            {shop.review_count && (
                              <span className="text-gray-400 dark:text-gray-500 ml-1">({shop.review_count})</span>
                            )}
                          </div>
                        ) : (
          ...
          {sortedShops.length === 0 && (
            <div className="col-span-full text-center py-12">
              <div className="bg-[#E4F5F0] dark:bg-[#2A866A]/20 p-10 rounded-xl max-w-md mx-auto">
                <Search className="h-12 w-12 text-[#2A866A] dark:text-[#4ECBA5] mx-auto mb-4" />
