...
const LoginPage = () => {
  ...
  const { login, googleSignIn, isLoggedIn, user } = useAuth();
  ...
  return (
    <AuthLayout 
      title="Welcome Back" 
      subtitle="Log in to your Haluna account"
    >
      <motion.div variants={itemVariants}>
        <AuthRoleSelector onSelect={setUserType} selectedType={userType} />
      </motion.div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <motion.div variants={itemVariants}>
          <div className="flex items-center justify-between mb-1">
            <Label htmlFor="password" className="text-sm font-medium text-haluna-text">
              Password
            </Label>
            <Link to="/forgot-password" className="text-xs text-haluna-primary hover:underline transition-colors">
              Forgot password?
            </Link>
          </div>
          <div className="relative">
