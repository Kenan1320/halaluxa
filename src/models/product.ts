...
// Updated mock products data with multiple images and seller information
export const mockProducts: Product[] = [
  {
    ...
    longDescription: `<p>Our Organic Halal Chicken is sourced from free-range farms where chickens are raised in a natural environment without antibiotics or hormones. The chickens are fed a natural diet and are processed according to strict Halal guidelines.</p>
  ...
  },
  {
    ...
    longDescription: `<p>Our Navy Blue Modest Hijab is designed for comfort and style. Made from premium cotton blend fabric, it drapes beautifully and stays in place throughout the day.</p>
  ...
  },
  {
    ...
    longDescription: `<p>Our Natural Rose Water Face Toner is made from 100% pure rose water, distilled from fresh Damascus roses. This alcohol-free toner is perfect for all skin types, especially sensitive skin.</p>
  ...
  },
  {
    ...
    longDescription: `<p>Our Decorative Arabic Calligraphy Frame features intricate hand-crafted calligraphy in a beautiful walnut wood frame. Each piece is unique and made by skilled artisans who have perfected their craft over generations.</p>
